        ...
        <div className="flex min-h-[420px] items-center justify-center text-center">
          <div className="max-w-sm">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-400">
              Выберите маршрут в списке слева, чтобы посмотреть карточку маршрута и детали
              операции.
            </p>
          </div>
        </div>
    ...
    <aside className="glass-panel h-fit p-5 sm:p-6 xl:sticky xl:top-6">
      ...
      <section className="mt-5">
        ...
        {isStepLoading ? (
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-none border border-white/[0.06] bg-[linear-gradient(180deg,rgba(15,24,35,0.42),rgba(10,18,27,0.52))] px-4 py-3">
              <div className="text-sm font-medium text-slate-100">
                Дегазация: {formatPostProcessWaitHours(step.post_process_wait_hours)}
              </div>
            </div>
          ...
          <div className="rounded-none border border-cyan-300/8 bg-[linear-gradient(180deg,rgba(18,31,43,0.72),rgba(10,19,29,0.76))] px-4 py-5 text-sm text-slate-300">
            Операция получения не задана.
          </div>
        )}
      </section>
      ...
      <section className="mt-6">
        <div className="mb-3 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div className="text-lg font-medium text-slate-50">Входы операции</div>
          </div>
          <button
            type="button"
        ...
        {!step ? (
          <div className="rounded-none border border-white/[0.06] bg-[linear-gradient(180deg,rgba(16,26,37,0.58),rgba(10,18,27,0.7))] px-4 py-4 text-sm text-slate-400">
            Сначала задайте операцию получения.
          </div>
        ) : isInputsLoading ? (
          <div className="rounded-none border border-white/[0.06] bg-[linear-gradient(180deg,rgba(16,26,37,0.58),rgba(10,18,27,0.7))] px-4 py-4 text-sm text-slate-400">
            Загрузка входов операции...
          </div>
        ) : inputsError ? (
          <div className="rounded-none border border-rose-300/30 bg-rose-500/[0.1] px-4 py-4 text-sm text-rose-100">
            {inputsError}
          ...
          <div className="rounded-none border border-white/[0.06] bg-[linear-gradient(180deg,rgba(16,26,37,0.58),rgba(10,18,27,0.7))] px-4 py-4 text-sm text-slate-400">
            Для этой операции пока нет входов. Добавьте первый вход.
          </div>
        ) : (
          <div className="space-y-3">
            {inputs.map((input) => {
              ...
              return (
                <div
                  ...
                  className={[
                    ...
                    isPurchased
                      ? "border-amber-300/30 bg-amber-400/[0.03]"
                ...
                >
                  <div className="mb-3 flex items-center justify-between gap-3">
                    <span
                      className={[
                        "inline-flex rounded-none border px-2.5 py-1 text-[11px] uppercase tracking-[0.12em]",
                        isPurchased
      ...
      <section className="mt-6">
        <div className="mb-3 flex items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div className="text-lg font-medium text-slate-50">Оборудование операции</div>
          </div>
          <button
            type="button"
        ...
        {!step ? (
          ...
          <div className="rounded-none border border-white/[0.06] bg-[linear-gradient(180deg,rgba(16,26,37,0.58),rgba(10,18,27,0.7))] px-4 py-4 text-sm text-slate-400">
            Загрузка оборудования операции...
          </div>
        ) : equipmentError ? (
          <div className="rounded-none border border-rose-300/30 bg-rose-500/[0.1] px-4 py-4 text-sm text-rose-100">
            {equipmentError}
          ...
          <div className="rounded-none border border-white/[0.06] bg-[linear-gradient(180deg,rgba(16,26,37,0.58),rgba(10,18,27,0.7))] px-4 py-4 text-sm text-slate-400">
            Для этой операции пока нет оборудования. Добавьте первую единицу.
          </div>
        ) : (
          <div className="space-y-3">
              ...
              return (
                <div
                  ...
                  className={[
                    "rounded-none border px-4 py-4",
                    isPrimary
                      ? "border-cyan-200/20 bg-[linear-gradient(180deg,rgba(25,88,114,0.28),rgba(11,30,44,0.62))]"
                      : "border-slate-200/18 bg-[linear-gradient(180deg,rgba(52,63,82,0.28),rgba(19,25,34,0.62))]",
                  ].join(" ")}
                >
                  <div className="mb-3 flex items-center justify-between gap-3">
                    <div
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="text-right">
                      ...
                      <div className="mt-2 text-xs text-slate-300">
                        Мин. партия:{" "}
                        {equipmentItem.min_batch_qty == null
                          ? "—"
                          : `${formatQty(equipmentItem.min_batch_qty)} ${outputNomenclatureUom || ""}`}
                      </div>
