      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <div className="panel-title">
            {isEditMode ? "Редактирование оборудования" : "Новая единица"}
          </div>
          <h2 className="mt-3 font-['Space_Grotesk'] text-3xl font-semibold text-slate-50">
            {isEditMode ? "Изменение оборудования" : "Создание оборудования"}
          </h2>
          <p className="mt-3 text-sm leading-6 text-slate-400">
            Заполните карточку единицы оборудования. После сохранения изменения сразу
