      ...
      <div className="mt-5 space-y-3">
        {isLoading ? (
          <div className="border border-white/[0.05] bg-[linear-gradient(180deg,rgba(16,26,37,0.58),rgba(10,18,27,0.7))] px-5 py-8 text-center">
            <div className="text-base font-medium text-slate-200">Загрузка номенклатуры...</div>
          </div>
        ) : items.length > 0 ? (
          items.map((item) => {
            ...
            return (
              <button
                ...
                type="button"
                onClick={() => onSelectItem(item.nomenclature_id)}
                className={[
                    ...
                    <span
                      className={[
                        ...
                        item.is_active
                          ...
                          : "border-amber-200/28 bg-amber-200/[0.08] text-amber-100/80",
                      ].join(" ")}
                    >
          ...
          <div className="border border-white/[0.05] bg-[linear-gradient(180deg,rgba(16,26,37,0.58),rgba(10,18,27,0.7))] px-5 py-8 text-center">
            <div className="text-base font-medium text-slate-200">Позиции не найдены</div>
