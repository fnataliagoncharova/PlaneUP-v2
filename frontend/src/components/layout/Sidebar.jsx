...
function Sidebar({ items, activeSection, onSelect, isCollapsed, onToggleCollapse }) {
  ...
  return (
    <aside
      className={[
        "w-full border-b border-cyan-300/10 bg-[linear-gradient(180deg,rgba(8,18,29,0.98),rgba(9,20,31,0.95)_55%,rgba(7,15,24,0.98))] transition-all duration-300 lg:border-b-0 lg:border-r lg:border-r-cyan-300/10",
    ...
    >
      <div className="flex h-full flex-col p-4 sm:p-5">
        <div
          className={[
            "glass-panel mb-5 flex items-center px-4 py-4",
